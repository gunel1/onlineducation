...
@section('title', "Komandamız | Onlayn Təhsil")
...
<section id="team">
        <div class="container">
            <div class="row">
                <h1 class="title text-center wow fadeInDown" data-wow-duration="500ms" data-wow-delay="300ms">KOMANDAMIZ</h1>
                        ...
                        <div class="item active">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    ...
                                    <div class="person-info">
                                        <h3>XOŞBƏXT ƏLİZADƏ</h3>
                                        <p>Marketinq &amp; Planlaşdırma Direktoru</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
